...
public class FlashCardExcretor extends AppCompatActivity {
    ...
    private QuestionModel[] mQuestionBank  = new QuestionModel[] {
            new QuestionModel (R.string.SistemaExcretor_um, false),
            new QuestionModel (R.string.SistemaExcretor_dois, false),
            new QuestionModel (R.string.SistemaExcretor_tres, true),
            new QuestionModel (R.string.SistemaExcretor_quatro, true),
            new QuestionModel (R.string.SistemaExcretor_cinco, false)
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flash_card_excretor);
