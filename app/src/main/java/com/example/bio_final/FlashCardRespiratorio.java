...
public class FlashCardRespiratorio extends AppCompatActivity {
    ...
    private QuestionModel[] mQuestionBank  = new QuestionModel[] {
            new QuestionModel (R.string.SistemaRespiratorio_um, false),
            new QuestionModel (R.string.SistemaRespiratorio_dois, true),
            new QuestionModel (R.string.SistemaRespiratorio_tres, true),
            new QuestionModel (R.string.SistemaRespiratorio_quatro, true),
            new QuestionModel (R.string.SistemaRespiratorio_cinco, false)
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flash_card_respiratorio);
